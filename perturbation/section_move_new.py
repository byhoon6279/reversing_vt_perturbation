...
#     try:
    print("rename_new_section start")
    data = bytearray(data)
    ...
    #for section_index, section in enumerate(executable_sections):
    target_section_len = 0 #len(executable_sections)
...
#     ori_dst_dir = '../sample/perturbated_labling_sample/section_move_new/'
...
#             if 'e820d88c1708d6dc1fdc43deb65b1ed1928f4502e3bc628b73a5d978850e4bfa.exe' not in sample:
#                 continue
