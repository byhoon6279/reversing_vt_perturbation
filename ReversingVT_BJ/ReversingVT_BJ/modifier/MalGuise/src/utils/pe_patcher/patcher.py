...
def patch_yourself(filename, call_info):
    ...
    pe.write('malware_samples/modified.exe')

if __name__ == '__main__':
    filename = 'malware_samples/shell.exe'
    call_info = ["0x40179c", "0x4017a1", "0x401AC7", False, False]
    patch_yourself(filename, call_info)