...
def modify_section(file_path, new_text, save_dir, modified_section_names):
    ...
    if idx == len(pe.sections) - 1: #overlay
        #print("   마지막이야?", section_name.lower())
        #print(tmp_binary[section.PointerToRawData+section.SizeOfRawData:])
    ...
    #print(file_path.replace(file_format, "_instruction_change"+file_format))
